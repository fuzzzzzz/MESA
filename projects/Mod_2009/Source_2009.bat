...
SET GAME_PROJECT_NAME=Mod using 2009 tools
SET SOURCE_BIN_PATH=%STEAMDIR%\steamapps\common\SourceSDK\bin\source2009\bin
SET GAME_PROJECT_SRC=%MESADIR%\projects\mod_2009
