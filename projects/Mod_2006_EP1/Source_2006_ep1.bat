@echo off
echo Configuring MESA environment variables for Source Sdk Base 2006 (Episode 1 sdk tools) .
...
echo ...
SET SOURCE_BIN_PATH=""%STEAMDIR%\steamapps\%STEAMUSER%\SourceSDK\bin\ep1\bin"
